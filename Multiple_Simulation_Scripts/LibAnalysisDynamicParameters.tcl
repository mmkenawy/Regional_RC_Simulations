...
#          RelativeEnergyIncr --
variable TolDynamic 0.01;                        # Convergence Test: tolerance
variable maxNumIterDynamic 2000;                # Convergence Test: maximum number of iterations that will be performed before "failure to converge" is returned
...
variable testTypeDynamic RelativeNormUnbalance;	# Convergence-test type
