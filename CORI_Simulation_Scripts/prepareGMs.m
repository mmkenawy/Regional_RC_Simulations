...
GMset = 'g23'; % NAME OF THE DIR CONTAINING THE GROUND MOTION .DATA FILES 
...
% % write file with path to ground motion acc time series (for local opensees
% % simulations - not needed for CORI simulations)
