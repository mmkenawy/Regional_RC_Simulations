 ...
 ###################################################################################################
	...
	source [pwd]/rotSpring2DModIKModel.tcl;	# procedure for defining a rotational spring (zero-length element)
	# define structure-geometry parameters
	source [pwd]/frameInfo$buildingName.tcl;
	source [pwd]/memParameters$buildingName.tcl;
 ...
 ###################################################################################################
	# define units
	if {$units == 1} {
		source [pwd]/LibUnitsNmm.tcl;			  	# define units
		} elseif {$units == 2} {
			source [pwd]/LibUnits.tcl;}	
...
# ################# RECORDERS FOR A SINGLE BUILDING RUN ######################################
